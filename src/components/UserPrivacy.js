...
export default class UserPrivacy extends Component {
  render() {
    return (
      <div>
        <h1 className="aboutUsTitle">User Privacy</h1>
...
You may not use any ShopLift Service if you are the subject of U.S. sanctions or of sanctions consistent with U.S. law imposed by the governments of the country where you are using Amazon Services. You must comply with all U.S. or other export and re-export restrictions that may apply to goods, software (including Amazon Software), technology, and services.
<br></br><br></br>
